...
import ImgBack from "../assets/png/back-button.png";
...
const CardNew = () => {
  ...
  return (
    <div>
      <div onClick={goBack} className="flex items-center mb-4 cursor-pointer">
        <img alt="back" src={ImgBack} className="h-6" />
        <p className="ml-2 text-lg">Go back</p>
      </div>
